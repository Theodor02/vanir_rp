...
function PANEL:Paint(width, height)
    ...
    -- Optionally, draw a semi-transparent overlay if you need to dim the background
    surface.SetDrawColor(10, 10, 10, 150) -- Adjust RGBA values as needed
    surface.DrawRect(0, 0, width, height)

    -- If you still need to call the base paint function, do it here
