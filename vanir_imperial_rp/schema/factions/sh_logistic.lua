FACTION.name = "Imperial Logistics Personnel"
FACTION.description = "Imperial Logistics. They are responsible for the transportation of goods and personnel. They are also responsible for the maintenance of the Empire's vehicles and equipment."
FACTION.isDefault = false
FACTION.color = Color(43, 100, 65)
FACTION.prefix = "LGS "
FACTION.pay = 25
